...
;(function ($, window, document, undefined) {
    ...
    $.extend(SmartWizard.prototype, {
        ...
        init: function () {
            ...
            this._showStep(idx);
            // Trigger init event - Fix glitched error
...
// PRIVATE FUNCTIONS
        ...
        _setToolbar: function () {
            ...
            var btnNext = (this.options.toolbarSettings.showNextButton !== false) ? $('<button></button>').text(this.options.lang.next).addClass('sw-btn-next pull-right').attr('type','button') : null;
            var btnPrevious = (this.options.toolbarSettings.showPreviousButton !== false) ? $('<button></button>').text(this.options.lang.previous).addClass('sw-btn-prev').attr('type','button') : null;
            var printBtnGroup = (this.options.toolbarSettings.showPrintButton == true) ? $('<div class="prt-btn-wrapper" style="display: none;"><button class="print prt-btn" id="print-table">Print</button><button class="save save-btn" id="save-table">Save</button></div>') : null;
            var btnGroup = $('<div></div>').addClass('navbar-btn sw-btn-group pull-' + this.options.toolbarSettings.toolbarButtonPosition).attr('role','group').append(printBtnGroup, btnPrevious, btnNext);
